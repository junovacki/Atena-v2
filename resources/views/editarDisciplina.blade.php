...
<body id="body">
    ...
    <div id="botaoVoltar">
        <a href="/dashboard-disciplina">Voltar</a>
    </div>
    ...
    <form id="formCadastro">
        <div id="campoLogin">
            Nome da disciplina: <input type="text" name="nome_disciplina" id="nome_disciplina" value="<?= $disciplinas[0]->nome_disciplina ?>"/>
        </div>
...
function enviar() {
        ...
        axios.post('http://127.0.0.1:8000/api/atualizarDisciplina', {
