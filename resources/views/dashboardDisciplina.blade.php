...
<body id="body">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                @if ($disciplina->ativo == '1')
                                                    <a  onclick="desativarDisciplina('<?= $disciplina->id?>')"  >
                                                        <i class="fa fa-toggle-on" aria-hidden="true" style="font-size: 30px"></i>
                                                    </a>
                                                @else
                                                    <a   onclick="ativarDisciplina('<?= $disciplina->id?>')" >
                                                ...
                                                <td>
                                                    ...
                                                    <a  class="button" id="view"  onclick="deletarDisciplina('<?= $disciplina->id?>')">
    ...
    <script>
        ...
        if (confirm(text) == true) {
            axios.post('http://127.0.0.1:8000/api/deletarDisciplina', {
            id: id
            })
            .then(function (response) {
                alert('Disciplina deletada com sucesso!!');
                window.location.href='/dashboard-disciplina';
            })
        ...
        function desativarDisciplina(id) {
        let text = "Deseja realmente desativar a disciplina?";
        if (confirm(text) == true) {
            axios.post('http://127.0.0.1:8000/api/desativar-disciplina', {
            id: id
            })
            .then(function (response) {
        ...
        function ativarDisciplina(id) {
        let text = "Deseja realmente ativar a disciplina?";
        if (confirm(text) == true) {
            axios.post('http://127.0.0.1:8000/api/ativar-disciplina', {
            id: id
            })
            .then(function (response) {
