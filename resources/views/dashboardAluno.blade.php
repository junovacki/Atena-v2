...
<body id="body">
    @if ($_COOKIE['nivelAcesso'] == 1)
        ...
        <div id="botaoCadUsuario">
            <a href="/cadastroAluno">Cadastro de alunos</a>
        </div>
                    ...
                    <div class="col-lx-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-description"> Todos os alunos cadastrados </p>
    ...
    <script>
        ...
        let text = "Deseja realmente deletar o Aluno?";
        if (confirm(text) == true) {
            axios.post('http://127.0.0.1:8000/api/deletarAluno', {
            id: id
            })
        ...
        let text = "Deseja realmente desativar o Aluno?";
        if (confirm(text) == true) {
            axios.post('http://127.0.0.1:8000/api/desativar-aluno', {
            id: id
            })
            .then(function (response) {
        ...
        let text = "Deseja realmente ativar o Aluno?";
        if (confirm(text) == true) {
            axios.post('http://127.0.0.1:8000/api/ativar-aluno', {
            id: id
            })
            .then(function (response) {
