...
<body id="body">
    ...
    <form id="formCadastro">
        <div id="campoLogin">
            Descrição da grade: <input type="text" name="nome_grade" id="nome_grade"/>
        </div>
            ...
            <div class="row">
                ...
                <div class="dual-list list-right col-md-5">
                    <div class="well">
                        ...
                        <ul class="list-group" id="selecionados">
        ...
        $(function () {
            ...
            $('.list-arrows span').click(function () {
                ...
                if ($button.hasClass('move-left')) {
                    ...
                    selecionados.pop(actives.clone());
                    actives.remove();
                    ...
                    selecionados.push(actives.remove());
                    actives.remove();
...
function enviar() {
    ...
    const filtered = final.filter((item, index) => final.indexOf(item) === index);

        axios.post('http://127.0.0.1:8000/api/registrarGrade', {
        ...
        .then(function (response) {
            ...
            alert(resposta.data);
            window.location.href='/cadastroGrade';
