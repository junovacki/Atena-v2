...
<body id="body">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                @if ($user->ativo == '1')
                                                    <a  onclick="desativarUsuario(<?= $user->id?>)"  >
                                                        <i class="fa fa-toggle-on" aria-hidden="true" style="font-size: 30px"></i>
                                                    </a>
                                                @else
                                                    <a   onclick="ativarUsuario(<?= $user->id?>)" >
                                                ...
                                                <td>
                                                    ...
                                                    <a  class="button" id="view"  onclick="deletarUsuario(<?= $user->id?>)">
    ...
    <script>
        ...
        if (confirm(text) == true) {
            axios.post('http://127.0.0.1:8000/api/deletarUsuario', {
            id: id
            })
        ...
        function desativarUsuario(id) {
            console.log('Erro na requisicao');
        let text = "Deseja realmente desativar o usuário?";
        if (confirm(text) == true) {
            axios.post('http://127.0.0.1:8000/api/desativar-usuario', {
            id: id
            })
            .then(function (response) {
        ...
        let text = "Deseja realmente ativar o usuário?";
        if (confirm(text) == true) {
            axios.post('http://127.0.0.1:8000/api/ativar-usuario', {
            id: id
            })
            .then(function (response) {
