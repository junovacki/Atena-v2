...
<body id="body">
    @if ($_COOKIE['nivelAcesso'] == 1)
        ...
        <div id="botaoCadUsuario">
            <a href="/cadastroCategoria">Cadastro de categoria</a>
        </div>
                    ...
                    <div class="col-lx-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-description"> Todas as categorias cadastradas </p>
    ...
    <script>
        ...
        let text = "Deseja realmente deletar a categoria?";
        if (confirm(text) == true) {
            axios.post('http://127.0.0.1:8000/api/deletarCategoria', {
            id: id
            })
        ...
        let text = "Deseja realmente desativar a categoria?";
        if (confirm(text) == true) {
            axios.post('http://127.0.0.1:8000/api/desativar-categoria', {
            id: id
            })
            .then(function (response) {
        ...
        let text = "Deseja realmente ativar a categoria?";
        if (confirm(text) == true) {
            axios.post('http://127.0.0.1:8000/api/ativar-categoria', {
            id: id
            })
            .then(function (response) {
