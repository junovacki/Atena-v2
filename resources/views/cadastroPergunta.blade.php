    ...
    <form id="formCadastro">
        ...
        <div>
            <div id="campoRespostaA">
                <input type="radio" name="radio" id="radioA" onchange="a()"> A) <textarea rows = "3" cols = "60" id = "respostaA" style="margin-left: 35px;">
                Escreva o texto da resposta aqui...
            </textarea>
            </div>
            <div id="campoRespostaB">
                <input type="radio" name="radio" id="radioB" onchange="b()"> B) <textarea rows = "3" cols = "60" id = "respostaB" style="margin-left: 35px;">
                Escreva o texto da resposta aqui...
            </textarea>
            </div>
            <div id="campoRespostaC">
                <input type="radio" name="radio" id="radioC" onchange="c()"> C) <textarea rows = "3" cols = "60" id = "respostaC" style="margin-left: 35px;">
                Escreva o texto da resposta aqui...
            </textarea>
            </div>
            <div id="campoRespostaD">
                <input type="radio" name="radio" id="radioD" onchange="d()" > D) <textarea rows = "3" cols = "60" id = "respostaD" style="margin-left: 35px;">
                Escreva o texto da resposta aqui...
            </textarea>
            <div id="campoRespostaE">
                <input type="radio" name="radio" id="radioE" onchange="e()"> E) <textarea rows = "3" cols = "60" id = "respostaE" style="margin-left: 35px;">
                Escreva o texto da resposta aqui...
            </textarea>
            </div>
        </div>
...
function enviar() {
        ...
        axios.post('http://127.0.0.1:8000/api/registrarPergunta', {
        ...
        .then(function (response) {
            ...
            alert(resposta.data);
            window.location.href='/cadastroPergunta';
