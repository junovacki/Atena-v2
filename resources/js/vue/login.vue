        ...
        methods: {
            formSubmitLogin(e) {
                ...
                .then(function (response) {
                    let resposta = JSON.parse(response.request.response);
                    console.log(resposta['nivelAcesso']);
                    if(resposta['retorno'] == 1){
                        alert('Logado com sucesso!!');
                        document.cookie = "login="+document.getElementById('user').value;
                        document.cookie = "nivelAcesso="+resposta['nivelAcesso'];
